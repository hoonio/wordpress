...
A major version upgrade is planned for later this year, which will be released as a new plugin, [Easy Google](http://wordpress.org/extend/plugins/easy-google/ "Easy Google, the next generation AdSense plugin"). This plugin will sport a modern, tabbed interface, and a completely re-written, refactored and optimized codebase and option data model, resulting in a more robust and extensible design, and better performance. The [current version](http://downloads.wordpress.org/plugin/easy-adsenser.2.8.zip "Version 2.9x of Easy AdSense") will always be available, if you need it.

= New in 2.98 =

More translation updates and support options, and Admin interface changes.
...
This post might help: [Modifying Easy Adsense Defaults](http://www.glebeterrace.com/blogging/wordpress/modifying-easy-adsense-defaults/ "An external blog post that gives step-by-step instructions on how to modify the default values").
...
* Turkish: [Omer Faruk](http://ramerta.com "Easy AdSense in Turkish (Turkce Ceviri)"), [Nurullah DEMIR](http://ndemir.com "Nurullah DEMIR"), [Murat Umutlu](http://www.simavlilar.com "Simav Sitesi Simav Bilgileri Simav Hakkõnda").
* Spanish: [Joaquin R. Rizer](http://www.shanky.com.ar "Joaquin R. Rizer"), [Maikel Frias](http://www.maikeladas.es "Maikel Frias"), [Argelio D&Atilde;&shy;az](http://www.goymad.com "El Ca&Atilde;&plusmn;izo"), [MaLk Gopher](http://malk-gopher.com/blog "MaLk Gopher & Friends"), [Pablog Pabloixx](http://rockstarunder.com.ar "RockStar Under"), [Navarra-Tu poblacion](http://navarra.tupoblacion.com "Navarra-Tu poblacion"), [Federico](http://www.posadasgalipan.com "Posadas Galipan"), [J. Marcos Troncoso](http://www.yanotesigue.com "@YaNoTeSigue")
* Portuguese: `pt_BR`: [Ivan Carlos](http://www.icarlos.net "Ivan Carlos"), [Carlos Henrique](http://www.nuncapare.com "NuncaPare"), [Murillo Ferrari](http://www.cparadiso.com.br "Cinema Paradiso"), [Eduardo Dantas Correia](http://eduardo.dantascorreia.com.br "Eduardo Dantas Correia"), [Leandro Vilela](http://www.vilela.pro.br "Leandro Vilela ._."), [Rubens Souza](http://www.panguo.com.br "Panguo"). `pt_PT`: [Rui Macdonald](http://ruimacdonald.com/wordpress "Rui Macdonald"), [jatefoste](http://jatefoste.com "Notícias sobre as últimas novidades tecnológicas"), [Tiago Alves](http://www.ptbyte.net/home ":::PTBYTE:::")
* Italian: [Angelo D Agostino](http://www.console-war.com "Angelo D Agostino"), [NokiaSymbian](http://www.nokiasymbian.it/wp "NokiaSymbian"), Saverio Tonno, [Fabio Napoleoni](http://techblog.zenit.org "Fabio's Tech Blog").
...
* German: [Ole Emken](http://www.ganz-einfach.com "GANZ EINFACH"), [Andre Foltys](http://www.kindergarten-tip.de "Kindergarten-Tip.de"), [Mathias Roth](http://trade-service.eu "Service Center Weserstrasse").
* Chinese: `zh_CN`: [Akii Snow](http://www.akii.org "Akii Snow"), [ShenMeng](http://shenmeng.org "ShenMeng"), [Joojen](http://www.keege.com "Joojen"). `zh_TW`: [AKiRA](http://akr.tw/ "AKiRA").
* Russian: ["ARCHIPOD"](http://archipod.ru "Vitaliy Alt"), [VN STUDIA](http://vlad.arvixe.ru, "VN-STUDIA") [be-os.ru](http://www.be-os.ru "be-os.ru")

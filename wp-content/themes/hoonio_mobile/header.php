...
<?php endif;?>
<meta name="Keywords" content="Hoonio, Seunghoon Kim, 김승훈, 金昇薫, Justino" /> 
...
<div id="header" onclick="location.href='<?php echo get_settings('home'); ?>';" style="cursor: pointer;">
     ...
     <?php if(is_page('Home')||is_page('Info')||is_page('Apps')||is_page('Foto')||is_page('Search Results')||is_page('Calendar')||is_page('Vitae')) : ?>
	<!-- do nothing-->
     <?php else : ?>
	<div id="nav">
			<div class="alignleft">

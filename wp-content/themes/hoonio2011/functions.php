...
add_theme_page('hoonio2011', 'hoonio2011 Options', 'edit_themes', basename(__FILE__), 'editoptions');
}
...
<h2 style="clear: both; margin-left: 5px; margin-bottom: 20px;">hoonio2011 Theme Settings Page</h2>
<?php 
$pathtemp = get_theme_root()."/hoonio2011";
$imagetemp = get_theme_root()."/hoonio2011/images/logos";
if(!is_writeable($pathtemp)) {
?>
<span style="float: left; margin-left: 10px; margin-top: 10px; background-color: #c03725; color: #FFF; padding: 5px;">Thumbnails not working - Please give write permission to Theme (hoonio2011) Folder (755 or 777)</span>
<?php
}
?>
<div class="container" style="clear: both; float: left; background-color: #e8e8e8; border: 0px solid #CCC; padding: 10px; font-size: 11px; width: 650px; margin: 10px; color: #3b3b3b;">
<?php 
if(!is_writeable($imagetemp)) {
?>
<span style="clear: both; margin-bottom: 10px; float: left; background-color: #c03725; color: #FFF; padding: 5px;">You cannot upload images because the folder "wp-content/themes/hoonio2011/images/logos/ is not writeable please CHMOD this folder to 755 or 777</span>
<?php } ?>
<h3>Custom Logo</h3>
...
<br/><br/><a style="background-color: #dedede; border: 0px solid #CCC; padding: 5px;" href="<?php echo $url,$admin;?>">Delete this image</a>
</div>
<?php } else { ?>
...
$file = get_option('logo_pic');
$admin = "/wp-admin/themes.php?page=functions.php&deleted=true";?>
<br/><br/><a style="background-color: #dedede; border: 0px solid #CCC; padding: 5px; float: left; clear: both;" href="<?php echo $url,$admin;?>">Delete this image</a><br/><br/>
<?php } } }?>
<?php if($_GET['pic'] || get_option('logo_pic')) { ?>
...
<div class="container" style="clear: both;background-color: #e8e8e8; border: 0px solid #CCC; padding: 10px; font-size: 11px; width: 650px; margin: 10px; float: left; color: #3b3b3b;">
